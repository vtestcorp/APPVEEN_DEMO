...
import com.appveen.pageobjects.DataAppCenterPage;
...
public class TC_01_CreateDS extends BaseClass {

	LoginPage loginPage;
	DashBoardPage dashBoardPage;
	DataServiceDesign dataServiceDesign;
	DataAppCenterPage dataAppCenterPage;

	@Test	
	public void createDataService1() throws Exception {
		...
		dataAppCenterPage = new DataAppCenterPage(driver, test);

		System.out.println("TC_01 Create Data Service started");
		...
		for (int testCaseAction = 0; testCaseAction < testCaseActions.size(); testCaseAction++) {
			...
			else if (testCaseActions.get(testCaseAction).equals("click_Groups")) {
				dataServiceDesign.click_Groups();
			}
			else if (testCaseActions.get(testCaseAction).equals("click_Admins")) {
				dataServiceDesign.click_Admins();
			}
			else if (testCaseActions.get(testCaseAction).equals("click_AppCenterRoles")) {
				dataServiceDesign.click_AppCenterRoles();
			}
			else if (testCaseActions.get(testCaseAction).equals("select_TestOneDataService")) {
				dataServiceDesign.select_DataServiceInAppCenterRoles(JsonUtils.getData(DefineConstants.TC_01_CreateDS, "New Data Service Name"));
			}
			else if (testCaseActions.get(testCaseAction).equals("enable_DataServiceManageButton")) {
				dataServiceDesign.enable_DataServiceManageButton();
			}
			else if (testCaseActions.get(testCaseAction).equals("click_SaveButtonAppCenterRoles")) {
				dataServiceDesign.click_SaveButtonAppCenterRoles();
			}
			else if (testCaseActions.get(testCaseAction).equals("click_SaveButtonAppCenterRoles")) {
				dataServiceDesign.click_SaveButtonAppCenterRoles();
			}
			else if (testCaseActions.get(testCaseAction).equals("click_AddButtonOnDataCenter")) {
				dataAppCenterPage.click_AddButtonOnDataCenter();
			}
			else if (testCaseActions.get(testCaseAction).equals("enter_IDOnDataCenter")) {
				dataAppCenterPage.enter_IDOnDataCenter(JsonUtils.getData(DefineConstants.TC_01_CreateDS, "ID"));
			}
			else if (testCaseActions.get(testCaseAction).equals("enter_AttributeOneOnDataCenter")) {
				dataAppCenterPage.enter_AttributeOneOnDataCenter(JsonUtils.getData(DefineConstants.TC_01_CreateDS, "Attribute One Value"));
			}
			else if (testCaseActions.get(testCaseAction).equals("enter_AttributeTwoOnDataCenter")) {
				dataAppCenterPage.enter_AttributeTwoOnDataCenter(JsonUtils.getData(DefineConstants.TC_01_CreateDS, "Attribute Two Value"));
			}
			else if (testCaseActions.get(testCaseAction).equals("enter_AttributeThreeOnDataCenter")) {
				dataAppCenterPage.click_AttributeThreeOnDataCenter();
			}
			else if (testCaseActions.get(testCaseAction).equals("enter_AttributeFourOnDataCenter")) {
				dataAppCenterPage.enter_AttributeFourOnDataCenter(JsonUtils.getData(DefineConstants.TC_01_CreateDS, "Attribute Four Value"));
			}
			else if (testCaseActions.get(testCaseAction).equals("click_SaveButtonOnDataCenter")) {
				dataAppCenterPage.click_SaveButtonOnDataCenter();
			}
		}
	}
}
